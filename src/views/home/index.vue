  ...
  div(class="relative md:min-h-screen md:flex before:bg-orange-100 before:h-2/3 before:absolute before:w-full before:bottom-0 before:inset-x-0 before:-z-20 md:before:w-1/3 md:before:h-full")
    div(ref="selfCard" class="perspective-4 pt-16 md:py-16 container md:flex md:items-center lg:max-w-[75%] xl:max-w-[60%]")
      div(:style="selfCardStyle" class="relative mx-auto px-4 pt-6 max-w-xs min-w-max shadow-lg bg-orange-50 text-center rounded-lg overflow-auto md:flex-1")
        ...
        div(class="absolute inset-x-0 bottom-0 flex justify-center items-center w-full h-12 bg-white")
          a(
            ...
            fontawesome-icon(v-if="community.icon" :icon="community.icon" class="w-6 h-6")
      div(class="py-6 overflow-hidden md:flex-1 md:ml-6")
        ...
        p(class="mt-3 md:text-lg" data-aos="fade-right") {{ $t('text.工作自介') }}
        p(class="mt-3 md:text-lg" data-aos="fade-right" data-aos-delay="200") {{ $t('text.攝影自介') }}
  skill-comp
</template>
